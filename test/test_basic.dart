...
class Sample extends Object with AopWrappers {
  void methodXYZ(String a,{ciccio}) { $aop$(new InvokationContext('pointcut1','methodXYZ',[a],{'ciccio':ciccio}),() {
    print(a);
  });}
  int methodA(int b,[int x=10]) { return $aop$(new InvokationContext('pointcut1','methodA',[b,x],{}),() {
    return b+x;
  });}

  methodVarRet(x,b,z) { return $aop$(new InvokationContext('pointcut1','methodVarRet',[x,b,z],{}),() {
    return x+b-z;
  });}
}
...
void main() {
  ...
  group("zero",(){
    setUp(() {
      pointcutRegistry.register("pointcut1",(InvokationContext ctx,Function proceed) {
